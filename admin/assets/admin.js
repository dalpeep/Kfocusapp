...
function renderNewsroom(){
  ...
  if(!items.length){box.innerHTML='<div class="newsroom-empty"><strong>처리할 후보가 없습니다.</strong><span>자동 수집은 매일 오전 6시에 실행됩니다. 필요할 때만 지금 다시 수집을 사용하세요.</span></div>';return;}
