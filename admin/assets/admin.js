...
const DALPICK_LABELS={local_info:'지역 정보',lifestyle:'생활 정보',themed:'테마 추천',recommended:'추천 업소',new_business:'신규 업소',coupon:'쿠폰',event:'행사',ai_pick:'AI 추천',seasonal:'시즌 추천',promotion:'프로모션',business_story:'업소탐방 Premium'};
...
const DALPICK_TYPE_HELP={local_info:'지역 명소, 여행지, 계절 정보를 업소 연결 없이 작성할 수 있습니다.',lifestyle:'텍사스 생활 팁과 실용 정보를 특정 업체 홍보 없이 작성합니다.',themed:'특정 업소를 연결하지 않고, 선택한 업종의 상세페이지 상단에 공통 테마로 노출할 수 있습니다.',recommended:'선택한 업소를 중심으로 추천 콘텐츠를 작성합니다.',new_business:'새로 등록된 업소의 특징을 소개합니다.',coupon:'쿠폰이나 프로모션 내용을 소개합니다. 업소 연결을 권장합니다.',event:'지역 행사나 이벤트를 소개합니다. 업소 연결은 선택 사항입니다.',business_story:'업소탐방은 특정 업소와 연결해야 하며 커뮤니티와 업소 상세에 함께 노출됩니다.'};
...
function updateDalpickTypeUI(){
  ...
  const targetFields=qs('dalpickTargetCategoryFields'); if(targetFields) targetFields.hidden=category!=='themed';
