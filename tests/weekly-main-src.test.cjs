...
const html=fs.readFileSync(path.join(root,'index.html'),'utf8');assert.ok(html.includes('/app-v99.js?v=269.5-special-detail'));assert.ok(app.includes("DTM_BUILD_VERSION='269.1'"));
