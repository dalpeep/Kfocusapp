...
async function openaiCollect(region='dallas'){
  ...
  const prompt=`You collect source records for a Dallas-Fort Worth local newsroom. Current UTC time: ${now.toISOString()}.
Search for meaningful items published or materially updated since ${since}. Prioritize first-party official sources: City of Dallas, Dallas County, DART, TxDOT Dallas District, Plano, Carrollton, Frisco, Allen, McKinney, Richardson, Irving, Garland, Coppell, Lewisville, Little Elm, official police/fire departments, Dallas/Plano/Frisco/Allen/CFB/Lewisville ISDs, NWS Fort Worth, and official event pages. Use reputable local media only when no adequate official source exists.
Do not summarize into a Korean article yet. Do not classify, recommend businesses, or write an article. Return only raw source records that can be reviewed later. Exclude old pages, generic promotions, sports recaps, duplicates and unverifiable items.
Return ONLY valid JSON:
{"items":[{"original_title":"","original_summary":"1-3 factual sentences in the source language","original_url":"https://...","source_name":"","source_kind":"official","source_published_at":"ISO or null","area":"Dallas-Fort Worth"}]}`;
